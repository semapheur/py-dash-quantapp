...
li_style = "flex flex-col items-center gap-y-8 w-max "
...
def card(
  ...
  return html.Div(
    ...
    children=[
      ...
      html.Span(bottom_text, id=bottom_id, className=bottom_style),
    ],
  )
...
def DupontChart(id_prefix: str = "span:dupont-chart:"):
  return html.Div(
    ...
    children=[
      ...
      html.Ul(
        className=h_branch + "before:left-[17.55rem] before:w-[56.4rem]",
        children=[
          html.Li(
            className=li_style,
            children=[
              ...
              html.Ul(
                className=h_branch + "before:left-20 before:w-[25.1rem]",
                children=[
                  html.Li(
                    className=li_style,
                    children=[
                        ...
                        children=[
                          html.Li(
                            ...
                            children=[
                              card(
                                top_text="Net Income",
                                bottom_id=id_prefix + "income_loss_net",
                                buds=("left",),
                              )
                            ],
                          ),
                          ...
                          html.Li(
                            ...
                            children=[
                              card(
                                ...
                                bottom_id=id_prefix + "tax_burden:income_loss_pretax",
                                buds=("left",),
                              )
                            ],
                          ),
          ...
          html.Li(
            ...
            children=[
              ...
              html.Ul(
                className=h_branch + "before:left-20 before:w-[12.6rem]",
                children=[
                  html.Li(
                    className=li_style,
                    children=[
