...
class Ticker():
    ...
    apiKey = '35220880cad76b7452c77c67fc91f9a5'
    ...
    # timeFrame: annual/quarter
        ...
        for k, v in interval.items():
            ...
            for i, sheet in enumerate(sheets):
                ...
                url = (f'https://financialmodelingprep.com/api/v3/{sheet}/'
                ...
                temp.drop(['symbol', 'acceptedDate', 'period', 'link'], axis=1, 
                          inplace=True)
        ...
        df.drop(['cashAtEndOfPeriod', 'cashAtBeginningOfPeriod', 
                 'operatingCashFlow'], axis=1, inplace=True)
...
def getTickers():
    ...
    df['tickerTrim'] = df['ticker'].apply(lambda x: re.sub(pattern, '', x.lower().split('.')[0]))
